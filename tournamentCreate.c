...
int createTournament(team *all_teams, const int number_of_teams, match *tournament, const int number_of_matches, const int number_of_fields) {
  ...
  for (round_count = 0; round_count < number_of_rounds; round_count++){
    ...
    end_of_round = createMatch(tournament, all_teams, team_a, team_b, start_of_next_round, start_of_round, number_of_teams, number_of_fields);
...
int createMatch(match *tournament, team *all_teams, int *team_a, int *team_b, const int start_of_next_round, const int start_of_round, const int number_of_teams, const int number_of_fields) {
